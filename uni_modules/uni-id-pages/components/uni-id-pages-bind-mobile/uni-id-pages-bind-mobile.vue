<template>
	<uni-popup ref="popup" type="bottom">
		<view class="box">
			...
			<text class="tip">Get your mobile phone number and bind it to your personal information with one click</text>
			<view class="btnBox">
				<text @click="closeMe" class="close">Close</text>
				<button class="agree uni-btn" type="primary" open-type="getPhoneNumber"
					@getphonenumber="bindMobileByMpWeixin">Obtain</button>
			</view>
		</view>
	</uni-popup>
</template>
