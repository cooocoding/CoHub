			...
			return {
				...
				univerifyStyle: { //一键登录弹出窗的样式配置参数
					...
					"privacyTerms": {
						...
						"prefix": "I have read and agree", // 条款前的文案 默认值：“我已阅读并同意”
						"suffix": "and log in using your own number", // 条款后的文案 默认值：“并使用本机号码登录”
						"privacyItems": []
					}
				}
			}
