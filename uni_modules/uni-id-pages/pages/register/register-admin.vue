...
<template>
	<view class="uni-content">
		<match-media :min-width="690">
			...
			<!-- 顶部文字 -->
			<text class="title title-box">Create super administrator</text>
		</match-media>
		<uni-forms ref="form" :value="formData" :rules="rules" validate-trigger="submit" err-show-type="toast">
			...
			<uni-forms-item name="nickname">
				<uni-easyinput :inputBorder="false" :focus="focusNickname" @blur="focusNickname = false" class="input-box" placeholder="Please enter user nickname" v-model="formData.nickname"
					trim="both" />
			</uni-forms-item>
		...
		methods: {
			...
			submitForm(params) {
				...
				.catch(e => {
					...
					uni.showModal({
						title: 'Tips',
						content: e.errMsg || `Creation failed: ${e.errCode}`,
						showCancel: false
					})
				})
			},
