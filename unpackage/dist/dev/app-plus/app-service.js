...
(function(vue, shared) {
  ...
  const __easycom_0$e = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["render", _sfc_render$Z], ["__scopeId", "data-v-d31e1c47"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  const _sfc_main$Z = {
    name: "cmd-icon",
    props: {
      /**
  ...
  const __easycom_0$d = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["render", _sfc_render$Y], ["__scopeId", "data-v-7cd7d81f"], ["__file", "D:/project/CoHub/CoHub/components/cmd-icon/cmd-icon.vue"]]);
  const _sfc_main$Y = {
    name: "cmd-nav-bar",
    components: {
  ...
  const CmdNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [["render", _sfc_render$X], ["__scopeId", "data-v-80f5af22"], ["__file", "D:/project/CoHub/CoHub/components/cmd-nav-bar/cmd-nav-bar.vue"]]);
  const _sfc_main$X = {
    name: "uniCombox",
  ...
  function _sfc_render$W(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uni_icons = resolveEasycom(vue.resolveDynamicComponent("uni-icons"), __easycom_0$e);
    return vue.openBlock(), vue.createElementBlock(
      "view",
      {
  ...
  const __easycom_0$c = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["render", _sfc_render$W], ["__scopeId", "data-v-e602780e"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-combox/components/uni-combox/uni-combox.vue"]]);
  const _sfc_main$W = {
    name: "UniSection",
    emits: ["click"],
    props: {
  ...
  const __easycom_1$5 = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["render", _sfc_render$V], ["__scopeId", "data-v-637fd36b"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-section/components/uni-section/uni-section.vue"]]);
  const pages = [
    {
...
`, a3 = we(o3, e3.secretKey).toString(At);
  ...
  function Kn(e2) {
    ...
    e2.callFunction = function(t3) {
      ...
      let o2, a2;
      if (t3.data = t3.data || {}, e2.__dev__.debugInfo && !e2.__dev__.debugInfo.forceRemote && C$1 ? (e2._callCloudFunction || (e2._callCloudFunction = n2, e2._callLocalFunction = Ut), o2 = Ut) : o2 = n2, o2 = o2.bind(e2), Mn(t3))
        a2 = n2.call(e2, t3);
      else if (Dn(t3)) {
...
详细信息：${s4}`), r3(i3);
  ...
  const us = !!pagesJson.uniIdRouter;
  const { loginPage: hs, routerNeedLogin: ls, resToLogin: ds, needLoginPage: ps, notNeedLoginPage: fs, loginPageInTabBar: gs } = function({ pages: t2 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = pagesJson) {
  ...
  const __easycom_0$b = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["render", _sfc_render$U], ["__scopeId", "data-v-9245e42c"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-load-more/components/uni-load-more/uni-load-more.vue"]]);
  const _sfc_main$U = {
  ...
  function _sfc_render$T(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uni_load_more = resolveEasycom(vue.resolveDynamicComponent("uni-load-more"), __easycom_0$b);
    return vue.openBlock(), vue.createElementBlock(
      "view",
      {
  ...
  const __easycom_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["render", _sfc_render$T], ["__scopeId", "data-v-2f788efd"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-data-checkbox/components/uni-data-checkbox/uni-data-checkbox.vue"]]);
  const _sfc_main$T = {
    data() {
      return {
        isVisible: false,
      ...
      toggleTagList() {
        if (this.isTagListVisible) {
          this.selectedTags = this.checkbox2.map((tagValue) => {
            const tag = this.hobby.find((h2) => h2.value === tagValue);
            return tag ? tag.text : "";
          });
  ...
  function _sfc_render$S(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uni_combox = resolveEasycom(vue.resolveDynamicComponent("uni-combox"), __easycom_0$c);
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "font-style" }, [
      vue.createElementVNode("view", { class: "container" }, [
        vue.createElementVNode(
          "view",
          {
            class: vue.normalizeClass(["gray-overlay", { "show": $data.isInputFocused || $data.isFolderListVisible }])
          },
          null,
          2
          /* CLASS */
        ...
        vue.createElementVNode(
          "view",
          {
            class: vue.normalizeClass(["bottom-sheet", { "show": $data.isVisible }])
          },
          [
            vue.createElementVNode("view", { class: "sheet-content" }, [
              vue.createElementVNode("view", { class: "sheet-header" }, [
                vue.createElementVNode("text", { class: "sheet-title" }, "Add Link"),
                vue.createElementVNode("button", {
                  class: "done-btn",
                  onClick: _cache[0] || (_cache[0] = (...args) => $options.done && $options.done(...args))
                }, "Done")
              ]),
              ...
              vue.createElementVNode("view", { class: "sheet-body" }, [
                ...
                vue.createElementVNode("view", { class: "button-container" }, [
                  vue.createElementVNode("button", {
                    ...
                    onClick: _cache[4] || (_cache[4] = (...args) => $options.toggleFolderList && $options.toggleFolderList(...args))
                  }, "➕ Shared Folder"),
                  vue.createElementVNode("button", {
                    class: "action-button add-tag",
                    onClick: _cache[5] || (_cache[5] = (...args) => $options.toggleTagList && $options.toggleTagList(...args))
                  }, "➕ Add Tag")
                ])
              ])
            ]),
            vue.createCommentVNode(" 文件夹选项列表 "),
            vue.createElementVNode(
              "view",
              {
                class: vue.normalizeClass(["bottom-sheet folder-list-container", { "show": $data.isFolderListVisible }])
              },
              [
                vue.createElementVNode("view", { class: "sheet-content" }, [
                  vue.createElementVNode("view", { class: "sheet-header sticky" }, [
                    vue.createElementVNode("text", { class: "sheet-title" }, "Select Folder"),
                    vue.createElementVNode("button", {
                      class: "done-btn",
                      onClick: _cache[6] || (_cache[6] = (...args) => $options.toggleFolderList && $options.toggleFolderList(...args))
                    }, "Close")
                  ]),
                  vue.createElementVNode("view", { class: "sheet-body" }, [
                      ...
                      default: vue.withCtx(() => [
                        vue.createElementVNode("view", { class: "example-body" }, [
                          vue.createVNode(_component_uni_combox, {
                            ...
                            "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => $data.city = $event)
                          }, null, 8, ["candidates", "modelValue"]),
                          vue.createElementVNode("view", { class: "result-box" }, [
                            vue.createElementVNode(
                              "text",
                              null,
                              "Selected: " + vue.toDisplayString($data.city),
                              1
                              /* TEXT */
                            )
                          ])
            ...
            vue.createCommentVNode(" 标签选项列表 "),
            vue.createElementVNode(
              "view",
              {
                class: vue.normalizeClass(["bottom-sheet tag-list-container", { "show": $data.isTagListVisible }])
              },
              [
                vue.createElementVNode("view", { class: "sheet-content" }, [
                  vue.createElementVNode("view", { class: "sheet-header sticky" }, [
                    vue.createElementVNode("text", { class: "sheet-title" }, "Add Tag"),
                    vue.createElementVNode("button", {
                      class: "done-btn",
                      onClick: _cache[8] || (_cache[8] = (...args) => $options.toggleTagList && $options.toggleTagList(...args))
                    }, "Close")
                  ]),
                  vue.createElementVNode("view", { class: "sheet-body" }, [
                    vue.createVNode(_component_uni_section, {
                      ...
                      default: vue.withCtx(() => [
                        vue.createElementVNode("view", { class: "uni-px-5 uni-pb-5" }, [
                          vue.createElementVNode(
                            "view",
                            { class: "text" },
                            "Selected: " + vue.toDisplayString(JSON.stringify($data.checkbox2)),
                            1
                            /* TEXT */
                          ),
  ...
  const Add = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["render", _sfc_render$S], ["__scopeId", "data-v-0b59ba63"], ["__file", "D:/project/CoHub/CoHub/pages/grid/add.vue"]]);
  const _sfc_main$S = {
    components: {
      CmdNavBar,
      Add
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        ...
        vue.createElementVNode("view", { class: "pages font-style" }, [
          ...
          $options.isAnyItemSelected ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 0,
            class: "top-bar"
          }, [
            vue.createElementVNode("button", {
              class: "nav-button left",
              onClick: _cache[0] || (_cache[0] = (...args) => $options.selectAll && $options.selectAll(...args))
            }, "SELECT ALL"),
            vue.createElementVNode("button", {
                ...
                vue.createElementVNode("view", { class: "goods-content-wrap" }, [
                  ...
                  vue.createElementVNode("view", { class: "goods-option" }, [
                    (vue.openBlock(true), vue.createElementBlock(
                      vue.Fragment,
                      null,
                      vue.renderList(item.tags, (tag, tagIndex) => {
                        return vue.openBlock(), vue.createElementBlock(
                          "view",
                          {
                            key: tagIndex,
          ...
          $data.isEditPopupVisible ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 2,
            class: "edit-popup"
          }, [
            vue.createElementVNode("view", { class: "edit-popup-content" }, [
              vue.withDirectives(vue.createElementVNode(
                ...
                [vue.vModelText, $data.newTitle]
              ]),
              vue.createElementVNode("view", { class: "row" }, [
                vue.createElementVNode("button", {
                  onClick: _cache[8] || (_cache[8] = (...args) => $options.saveTitle && $options.saveTitle(...args))
                }, "Save"),
                vue.createElementVNode("button", {
          ...
          $data.isSharePopupVisible ? (vue.openBlock(), vue.createElementBlock("view", {
            ...
            vue.createElementVNode("view", { class: "share-popup-content" }, [
              vue.createElementVNode("view", { class: "share-popup-top" }, [
                vue.createElementVNode("image", {
                  src: "/static/pic/link.png",
                  class: "share-popup-image"
                }),
                vue.createElementVNode("view", { class: "share-popup-text" }, [
                  vue.createElementVNode("view", { class: "invite-text" }, "Shared Link"),
                  vue.createElementVNode("view", { class: "link-text" }, "Anyone with the link")
                ])
              ])
            ]),
            vue.createElementVNode("button", {
        ...
        vue.createVNode(_component_add, {
          ref: "addComponent",
          onAddItem: $options.addItem
        }, null, 8, ["onAddItem"])
      ],
      64
      /* STABLE_FRAGMENT */
  ...
  const PagesGridGrid = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["render", _sfc_render$R], ["__scopeId", "data-v-22222d69"], ["__file", "D:/project/CoHub/CoHub/pages/grid/grid.vue"]]);
  const _sfc_main$R = {
    name: "UniStatusBar",
    data() {
      return {
  ...
  const __easycom_0$a = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [["render", _sfc_render$P], ["__scopeId", "data-v-26544265"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-nav-bar/components/uni-nav-bar/uni-nav-bar.vue"]]);
  ...
  const __easycom_0$9 = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["render", _sfc_render$O], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-dateformat/components/uni-dateformat/uni-dateformat.vue"]]);
  const _sfc_main$O = {
    name: "UniBadge",
    emits: ["click"],
    props: {
  ...
  const __easycom_1$4 = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["render", _sfc_render$N], ["__scopeId", "data-v-c97cb896"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-badge/components/uni-badge/uni-badge.vue"]]);
  const _sfc_main$N = {
    name: "UniListItem",
  ...
  const __easycom_0$8 = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["render", _sfc_render$M], ["__scopeId", "data-v-c7524739"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-list/components/uni-list-item/uni-list-item.vue"]]);
  const _sfc_main$M = {
    name: "uniList",
    "mp-weixin": {
      options: {
  ...
  const __easycom_1$3 = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["render", _sfc_render$L], ["__scopeId", "data-v-c2f1266a"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-list/components/uni-list/uni-list.vue"]]);
  const en$2 = {
    ...
    methods: {
      ...
      add(value, {
        ...
        db2.collection(this.mainCollection).add(value).then((res) => {
          ...
          if (showToast) {
            uni.showToast({
              title: toastTitle || t$3("uniCloud.component.add.success")
            });
          }
        }).catch((err) => {
          fail && fail(err);
      ...
      remove(id, {
        ...
        uni.showModal({
          title: confirmTitle || t$3("uniCloud.component.remove.showModal.title"),
          content: confirmContent || t$3("uniCloud.component.remove.showModal.content"),
          showCancel: true,
          success: (res) => {
            if (!res.confirm) {
              return;
      ...
      update(id, value, {
        ...
        return db2.collection(this.mainCollection).doc(id).update(value).then((res) => {
          ...
          if (showToast) {
            uni.showToast({
              title: toastTitle || t$3("uniCloud.component.update.success")
            });
          }
        }).catch((err) => {
          fail && fail(err);
  ...
  const __easycom_4$3 = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["render", _sfc_render$K], ["__file", "D:/Download/HBuilderX.4.15.2024050802/HBuilderX/plugins/uniapp-cli-vite/node_modules/@dcloudio/uni-components/lib/unicloud-db/unicloud-db.vue"]]);
  ...
  const _sfc_main$K = {
    ...
    methods: {
      ...
      setFavorite() {
        if (Ws.getCurrentUserInfo().tokenExpired < Date.now()) {
  ...
  const PagesListDetail = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["render", _sfc_render$J], ["__scopeId", "data-v-495067d4"], ["__file", "D:/project/CoHub/CoHub/pages/list/detail.vue"]]);
  class MPAnimation {
  ...
  const __easycom_0$7 = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["render", _sfc_render$I], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-transition/components/uni-transition/uni-transition.vue"]]);
  const _sfc_main$I = {
    name: "uniPopup",
    components: {},
  ...
  const __easycom_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["render", _sfc_render$H], ["__scopeId", "data-v-4dd3c44b"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-popup/components/uni-popup/uni-popup.vue"]]);
  const ADType = {
  ...
  const _imports_0$4 = "/uni_modules/uni-sign-in/static/background.png";
  ...
  const _sfc_main$H = {
    ...
    methods: {
      ...
      async showRewardedVideoAd() {
        ...
        if (res && res.length == 0) {
          let userId = Ws.getCurrentUserInfo().uid;
          if (!userId) {
  ...
  const __easycom_0$6 = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["render", _sfc_render$G], ["__scopeId", "data-v-dc1d9ace"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue"]]);
  const _sfc_main$G = {
    name: "cloud-image",
    emits: ["click"],
    props: {
  ...
  const __easycom_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["render", _sfc_render$F], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-id-pages/components/cloud-image/cloud-image.vue"]]);
  const _sfc_main$F = {
    name: "UniGridItem",
    inject: ["grid"],
    props: {
  ...
  const __easycom_3$3 = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["render", _sfc_render$E], ["__scopeId", "data-v-7a807eb7"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-grid/components/uni-grid-item/uni-grid-item.vue"]]);
  const _sfc_main$E = {
    name: "UniGrid",
    emits: ["change"],
    props: {
  ...
  const __easycom_4$2 = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["render", _sfc_render$D], ["__scopeId", "data-v-07acefee"], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-grid/components/uni-grid/uni-grid.vue"]]);
  ...
  const uniIdCo$b = Ws.importObject("uni-id-co");
  const db$4 = Ws.database();
  ...
  const mutations = {
    ...
    async updateUserInfo(data2 = false) {
      if (data2) {
        ...
        const uniIdCo2 = Ws.importObject("uni-id-co", {
          customUI: true
        });
        try {
  ...
  const _sfc_main$D = {
    ...
    methods: {
      ...
      async checkVersion() {
        ...
        formatAppLog("log", "at pages/ucenter/ucenter.vue:199", res);
      ...
      gotoMarket() {
        if (uni.getSystemInfoSync().platform == "ios") {
          ...
          formatAppLog("log", "at pages/ucenter/ucenter.vue:229", { appstoreid });
          plus.runtime.openURL("itms-apps://itunes.apple.com/cn/app/wechat/" + appstoreid + "?mt=8", (err) => {
            formatAppLog("log", "at pages/ucenter/ucenter.vue:231", "plus.runtime.openURL err:" + JSON.stringify(err));
          });
        }
      ...
      getScore() {
        ...
        db$3.collection("uni-id-scores").where('"user_id" == $env.uid').field("score,balance").orderBy("create_date", "desc").limit(1).get().then((res) => {
          formatAppLog("log", "at pages/ucenter/ucenter.vue:262", res);
      ...
      async share() {
        ...
        formatAppLog("log", "at pages/ucenter/ucenter.vue:283", { myInviteCode });
        let {
          appName,
          logo,
          company,
        ...
        uniShare$1.show({
          ...
          formatAppLog("log", "at pages/ucenter/ucenter.vue:344", e2);
        });
      }
    }
  };
  function _sfc_render$C(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_uni_list_item = resolveEasycom(vue.resolveDynamicComponent("uni-list-item"), __easycom_0$8);
    const _component_uni_list = resolveEasycom(vue.resolveDynamicComponent("uni-list"), __easycom_1$3);
    return vue.openBlock(), vue.createElementBlock("view", { class: "center font-style" }, [
      vue.createVNode(
  ...
  const PagesUcenterUcenter = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["render", _sfc_render$C], ["__scopeId", "data-v-b6546e32"], ["__file", "D:/project/CoHub/CoHub/pages/ucenter/ucenter.vue"]]);
  ...
  const _sfc_main$C = {
    ...
    onLoad() {
      ...
      uni.checkIsSupportSoterAuthentication({
        ...
        fail: (err) => {
          formatAppLog("log", "at pages/ucenter/settings/settings.vue:84", err);
        }
      });
    },
    onShow() {
    ...
    methods: {
      ...
      startSoterAuthentication(checkAuthMode) {
        formatAppLog("log", "at pages/ucenter/settings/settings.vue:116", checkAuthMode);
        ...
        this.checkIsSoterEnrolledInDevice({ checkAuthMode, title }).then(() => {
          formatAppLog("log", "at pages/ucenter/settings/settings.vue:121", checkAuthMode, title);
          uni.startSoterAuthentication({
            ...
            complete: (res) => {
              formatAppLog("log", "at pages/ucenter/settings/settings.vue:128", res);
            },
            success: (res) => {
              formatAppLog("log", "at pages/ucenter/settings/settings.vue:131", res);
              if (res.errCode == 0) {
                return uni.showToast({
            ...
            fail: (err) => {
              formatAppLog("log", "at pages/ucenter/settings/settings.vue:151", err);
              formatAppLog("log", "at pages/ucenter/settings/settings.vue:152", `认证失败:${err.errCode}`);
              uni.showToast({
      ...
      checkIsSoterEnrolledInDevice({ checkAuthMode, title }) {
        return new Promise((resolve, reject) => {
          uni.checkIsSoterEnrolledInDevice({
            checkAuthMode,
            success: (res) => {
              formatAppLog("log", "at pages/ucenter/settings/settings.vue:167", res);
              if (res.isEnrolled) {
                return resolve(res);
              }
              uni.showToast({
            ...
            fail: (err) => {
              formatAppLog("log", "at pages/ucenter/settings/settings.vue:178", err);
              uni.showToast({
      ...
      clearTmp() {
        ...
        uni.getSavedFileList({
          success: (res) => {
            if (res.fileList.length > 0) {
              uni.removeSavedFile({
                ...
                complete: (res2) => {
                  formatAppLog("log", "at pages/ucenter/settings/settings.vue:210", res2);
                  uni.hideLoading();
                  uni.showToast({
          ...
          complete: (e2) => {
            formatAppLog("log", "at pages/ucenter/settings/settings.vue:227", e2);
          }
        });
      },
      changeLanguage() {
        formatAppLog("log", "at pages/ucenter/settings/settings.vue:232", "语言切换");
        uni.showActionSheet({
          itemList: ["English", "简体中文"],
          success: (res) => {
            formatAppLog("log", "at pages/ucenter/settings/settings.vue:236", res.tapIndex);
  ...
  function _sfc_render$B(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uni_list_item = resolveEasycom(vue.resolveDynamicComponent("uni-list-item"), __easycom_0$8);
    const _component_uni_list = resolveEasycom(vue.resolveDynamicComponent("uni-list"), __easycom_1$3);
    return vue.openBlock(), vue.createElementBlock("view", { class: "content font-style" }, [
      ...
      vue.createVNode(_component_uni_list, {
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("view", {
            class: "item-content wider-item",
            onClick: _cache[0] || (_cache[0] = (...args) => $options.goToUserInfoPage && $options.goToUserInfoPage(...args))
          }, [
            vue.createElementVNode("image", {
              slot: "icon",
              src: "/static/pic/LeftAccessory.png",
              class: "icon"
            }),
            vue.createElementVNode("view", { class: "custom-list-item" }, [
              vue.createElementVNode("view", { class: "custom-list-item-column grey-text1" }, "Name"),
              vue.createElementVNode("view", { class: "custom-list-item-column grey-text2" }, "XXX@gmail.com"),
      ...
      vue.createVNode(_component_uni_list, {
        ...
        default: vue.withCtx(() => [
          ...
          vue.createElementVNode("view", { class: "horizontal-container" }, [
            vue.createElementVNode("image", {
              slot: "icons",
              src: "/static/pic/icnTime9.png",
              class: "icons"
            }),
            vue.createVNode(_component_uni_list_item, {
              class: "right-content",
          ...
          vue.createElementVNode("view", { class: "horizontal-container" }, [
            vue.createElementVNode("image", {
              slot: "icons",
              src: "/static/pic/icnDate.png",
              class: "icons"
            }),
            vue.withDirectives(vue.createVNode(_component_uni_list_item, {
              class: "right-content",
              title: _ctx.$t("settings.pushServer"),
              onClick: _cache[1] || (_cache[1] = ($event) => $data.pushIsOn ? $data.pushServer.off() : $data.pushServer.on()),
              showSwitch: "",
  ...
  const PagesUcenterSettingsSettings = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["render", _sfc_render$B], ["__file", "D:/project/CoHub/CoHub/pages/ucenter/settings/settings.vue"]]);
  ...
  const _imports_0$3 = "/static/uni-load-state/disconnection.png";
  const {
    t: t$2
  ...
  const __easycom_3$2 = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["render", _sfc_render$A], ["__scopeId", "data-v-740c4771"], ["__file", "D:/project/CoHub/CoHub/components/uni-load-state/uni-load-state.vue"]]);
  const _sfc_main$A = {
    data() {
      return {
        isLoading: true,
  ...
  const PagesUcenterReadNewsLogReadNewsLog = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["render", _sfc_render$z], ["__file", "D:/project/CoHub/CoHub/pages/ucenter/read-news-log/read-news-log.vue"]]);
  function o(o2) {
  ...
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["render", _sfc_render$y], ["__scopeId", "data-v-42fcb7aa"], ["__file", "D:/project/CoHub/CoHub/uni_modules/Sansnn-uQRCode/components/uqrcode/uqrcode.vue"]]);
  ...
  const PagesUcenterAboutAbout = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["render", _sfc_render$x], ["__scopeId", "data-v-aa205f0f"], ["__file", "D:/project/CoHub/CoHub/pages/ucenter/about/about.vue"]]);
  ...
  const Uni_modulesUniUpgradeCenterAppPagesUpgradePopup = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["render", _sfc_render$w], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-upgrade-center-app/pages/upgrade-popup.vue"]]);
  ...
  const PagesUcenterInviteInvite = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", _sfc_render$v], ["__file", "D:/project/CoHub/CoHub/pages/ucenter/invite/invite.vue"]]);
  const _sfc_main$v = {
    name: "uniFormsItem",
    options: {
      virtualHost: true
  ...
  function _sfc_render$l(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock(
      ...
      },
      {
        default: vue.withCtx(() => [
          vue.createElementVNode("view", { class: "box" }, [
            vue.createElementVNode("text", { class: "headBox" }, "Binding data"),
            vue.createElementVNode("text", { class: "tip" }, "Get your mobile phone number and bind it to your personal information with one click"),
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      ...
      vue.createVNode(_component_uni_list, null, {
        default: vue.withCtx(() => [
          ...
          vue.createVNode(_component_uni_list_item, {
            ...
            title: "Real-name Verified",
            rightText: $options.realNameStatus !== 2 ? "Not verified" : "Verified",
            link: ""
          }, null, 8, ["onClick", "rightText"]),
      ...
      $data.showLoginManage ? (vue.openBlock(), vue.createElementBlock(
        ...
        [
          ...
          }, "Logout")) : (vue.openBlock(), vue.createElementBlock("button", {
            key: 1,
          ...
          vue.createElementVNode(
            ...
            [
              vue.createElementVNode("label", { class: "checkbox-box" }, [
                ...
                vue.createElementVNode("text", { class: "text" }, "Agree")
              ])
            ],
            32
            /* NEED_HYDRATION */
              ...
              vue.renderList($options.agreements, (agreement, index) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  ...
                  $options.hasAnd($options.agreements, index) ? (vue.openBlock(), vue.createElementBlock("text", {
                    ...
                    class: "text and",
                    space: "nbsp"
                  }, " and ")) : vue.createCommentVNode("v-if", true)
                ]);
              }),
              128
              /* KEYED_FRAGMENT */
        ...
        },
        {
          default: vue.withCtx(() => [
            vue.createVNode(_component_uni_popup_dialog, {
              ...
              default: vue.withCtx(() => [
                vue.createElementVNode("view", { class: "content" }, [
                  vue.createElementVNode("text", { class: "text" }, "Please read and agree first"),
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
                    vue.renderList($options.agreements, (agreement, index) => {
  ...
  const uniIdCo$8 = Ws.importObject("uni-id-co");
          ...
          fail: (e2) => {
            ...
            switch (e2.errCode) {
              ...
              case 10010:
                ...
                content = e2.cause.message || "Error code: 10010";
                break;
              case 10011:
                title = "Authentication interrupted";
                content = e2.cause.message || "Error code: 10011";
                break;
              case 10012:
              ...
              case 10013:
                ...
                this.verifyFailContent = e2.cause.message || "Error code: 10013";
                this.getFrvAuthResult();
                formatAppLog(
                  "log",
              ...
              default:
                title = "";
                content = `Validate unknown error (${e2.errCode})`;
                break;
            }
      ...
      async getFrvAuthResult() {
        ...
        try {
          ...
          if (this.verifyFailContent) {
            formatAppLog("log", "at uni_modules/uni-id-pages/pages/userinfo/realname-verify/realname-verify.vue:216", `[frv-debug] The client fails to scan the face. The real person authentication service will query the specific reason. The reason is:${this.verifyFailContent}`);
          }
          uni.showModal({
      ...
      $options.isCertify ? (vue.openBlock(), vue.createBlock(_component_uni_list, { key: 0 }, {
        ...
        $data.verifyFail ? (vue.openBlock(), vue.createElementBlock(
          ...
          [
            ...
            }, "Restart verification")) : (vue.openBlock(), vue.createElementBlock("button", {
              key: 1,
              type: "primary",
            ...
            $options.isDev ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 2,
              class: "dev-tip"
            }, "Please check the detailed error")) : vue.createCommentVNode("v-if", true)
          ],
          64
          /* STABLE_FRAGMENT */
        )) : (vue.openBlock(), vue.createElementBlock(
          ...
          { key: 1 },
          [
            vue.createElementVNode("text", { class: "title" }, "Real-name verification"),
    ...
    methods: {
      ...
      toPage(path, index = 0) {
        if (this.getRoute(1) == path.split("?")[0] && this.getRoute(1) == "/uni_modules/uni-id-pages/pages/login/login-withoutpwd") {
          ...
          formatAppLog("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:232", "unexpected situation, path：" + path);
        }
      },
      async login_before(type, navigateBack = true, options = {}) {
        ...
        await new Promise((callback) => {
          plus.oauth.getServices((oauthServices) => {
            ...
            throw new Error("Failed to obtain service provider：" + JSON.stringify(err));
          });
        });
        if (!isAppExist) {
          return uni.showToast({
        ...
        if (type == "univerify") {
          ...
          let onButtonsClickFn = async (res) => {
            formatAppLog("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:352", "Clicked on third-party login，provider：", res, res.provider, this.univerifyStyle.buttons.list);
  ...
  function _sfc_render$g(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      ...
      vue.createElementVNode("text", { class: "title" }, "Please select login method"),
      vue.createCommentVNode(" 快捷登录框 当url带参数时有效 "),
      ["apple", "weixin", "weixinMobile"].includes($data.type) ? (vue.openBlock(), vue.createElementBlock(
        vue.Fragment,
        { key: 0 },
        [
          vue.createElementVNode("text", { class: "tip" }, "Your information will be obtained according to the authorization scope of the third-party account service platform"),
          vue.createElementVNode("view", { class: "quickLogin" }, [
            $data.type !== "weixinMobile" ? (vue.openBlock(), vue.createElementBlock("image", {
              ...
              "WeChat authorized mobile phone number login",
              32
              /* NEED_HYDRATION */
            )),
            vue.createVNode(
        ...
        { key: 1 },
        [
          vue.createElementVNode("text", { class: "tip" }, "Unregistered accounts will be automatically registered after passing verification"),
  ...
  const _sfc_main$g = {
    ...
    methods: {
      getImageCaptcha(focus = true) {
        ...
        const uniIdCo2 = Ws.importObject("uni-captcha-co", {
          customUI: true
        });
  ...
  function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      ...
      vue.createCommentVNode(" 顶部文字 "),
      vue.createElementVNode("text", { class: "title title-box" }, "Log in with account and password"),
      vue.createVNode(_component_uni_forms, null, {
        default: vue.withCtx(() => [
      ...
      vue.createElementVNode("view", { class: "link-box" }, [
        !_ctx.config.isAdmin ? (vue.openBlock(), vue.createElementBlock("view", { key: 0 }, [
          vue.createElementVNode("text", { class: "forget" }, "Forget?"),
          vue.createElementVNode("text", {
            class: "link",
        ...
        vue.createElementVNode(
          ...
          vue.toDisplayString(_ctx.config.isAdmin ? "Register an administrator account" : "Register an account"),
          1
          /* TEXT */
        ),
    ...
    methods: {
      ...
      nextStep() {
        uni.showModal({
          ...
          complete: (e2) => {
            if (e2.confirm) {
              const uniIdco = Ws.importObject("uni-id-co");
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      vue.createVNode(_component_uni_match_media, { "min-width": 690 }, {
        default: vue.withCtx(() => [
          ...
          vue.createCommentVNode(" 顶部文字 "),
          vue.createElementVNode("text", { class: "title title-box" }, "Bind phone number")
        ]),
        _: 1
        /* STABLE */
      }),
  ...
  const _sfc_main$9 = {
    ...
    computed: {
      tipText() {
        return "Verification code has been sent via SMS to" + this.phone;
      }
    },
    onLoad({
      phoneNumber
    ...
    methods: {
      submit() {
        ...
        if (this.code.length != 6) {
          ...
          return uni.showToast({
            title: "Verification code must be filled",
            icon: "none",
            duration: 3e3
          });
        }
  ...
  function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      ...
      vue.createCommentVNode(" 顶部文字 "),
      vue.createElementVNode("text", { class: "title" }, "please enter verification code"),
      vue.createElementVNode("text", { class: "tip" }, "Enter the graphic verification code first, and then get the SMS verification code"),
      vue.createVNode(_component_uni_forms, null, {
        default: vue.withCtx(() => [
          vue.createVNode(_component_uni_id_pages_sms_form, {
            focusCaptchaInput: "",
  ...
  const uniIdCo$6 = Ws.importObject("uni-id-co");
  const _sfc_main$8 = {
    mixins: [mixin],
    data() {
      return {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      vue.createVNode(_component_uni_match_media, { "min-width": 690 }, {
        default: vue.withCtx(() => [
          ...
          vue.createCommentVNode(" 顶部文字 "),
          vue.createElementVNode("text", { class: "title title-box" }, "Username and password registration")
        ]),
        _: 1
        /* STABLE */
      }),
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      vue.createVNode(_component_uni_match_media, { "min-width": 690 }, {
        default: vue.withCtx(() => [
          ...
          vue.createCommentVNode(" 顶部文字 "),
          vue.createElementVNode("text", { class: "title title-box" }, "Retrieve password through mobile phone verification code")
        ]),
        _: 1
        /* STABLE */
      }),
          ...
          vue.createVNode(_component_uni_match_media, { "min-width": 690 }, {
            default: vue.withCtx(() => [
              vue.createElementVNode("view", { class: "link-box" }, [
                ...
                }, "Retrieve password via email verification code"),
                vue.createElementVNode("view"),
                vue.createElementVNode("text", {
                  class: "link",
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      vue.createVNode(_component_uni_match_media, { "min-width": 690 }, {
        default: vue.withCtx(() => [
          ...
          vue.createCommentVNode(" 顶部文字 "),
          vue.createElementVNode("text", { class: "title title-box" }, "Change Password")
        ]),
        _: 1
        /* STABLE */
      }),
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      vue.createVNode(_component_uni_match_media, { "min-width": 690 }, {
        default: vue.withCtx(() => [
          ...
          vue.createCommentVNode(" 顶部文字 "),
          vue.createElementVNode("text", { class: "title title-box" }, "Email verification code registration")
        ]),
        _: 1
        /* STABLE */
      }),
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      vue.createVNode(_component_uni_match_media, { "min-width": 690 }, {
        default: vue.withCtx(() => [
          ...
          vue.createCommentVNode(" 顶部文字 "),
          vue.createElementVNode("text", { class: "title title-box" }, "Retrieve password via email verification code")
        ]),
        _: 1
        /* STABLE */
      }),
          ...
          vue.createVNode(_component_uni_match_media, { "min-width": 690 }, {
            default: vue.withCtx(() => [
              vue.createElementVNode("view", { class: "link-box" }, [
                ...
                }, "Retrieve password through mobile phone verification code"),
                vue.createElementVNode("view"),
                vue.createElementVNode("text", {
                  class: "link",
                  onClick: _cache[9] || (_cache[9] = (...args) => $options.backLogin && $options.backLogin(...args))
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-content" }, [
      vue.createVNode(_component_uni_match_media, { "min-width": 690 }, {
        default: vue.withCtx(() => [
          ...
          vue.createCommentVNode(" 顶部文字 "),
          vue.createElementVNode("text", { class: "title title-box" }, "Set password")
        ]),
        _: 1
        /* STABLE */
      }),
      vue.createVNode(_component_uni_forms, {
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("text", { class: "tip" }, "Input password"),
          vue.createVNode(_component_uni_forms_item, { name: "newPassword" }, {
            default: vue.withCtx(() => [
              vue.createVNode(_component_uni_easyinput, {
                focus: $data.focusNewPassword,
          ...
          vue.createElementVNode("text", { class: "tip" }, "Please enter the password again"),
          vue.createVNode(_component_uni_forms_item, { name: "newPassword2" }, {
            default: vue.withCtx(() => [
              vue.createVNode(_component_uni_easyinput, {
                focus: $data.focusNewPassword2,
          ...
          vue.createElementVNode("view", { class: "link-box" }, [
            ...
            }, "Jump")) : vue.createCommentVNode("v-if", true)
          ])
        ]),
        _: 1
        /* STABLE */
