import { shallowRef, ref, getCurrentInstance, openBlock, createElementBlock, normalizeStyle, toDisplayString, resolveDynamicComponent, createElementVNode, renderSlot, createVNode, createCommentVNode } from "vue";
...
const _style_0$1 = { "uni-icons": { "": { "fontFamily": "uniicons", "textDecoration": "none", "textAlign": "center" } } };
const getVal = (val) => {
  const reg = /^[0-9]*$/g;
