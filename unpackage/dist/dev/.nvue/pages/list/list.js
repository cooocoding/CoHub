...
import { openBlock, createElementBlock, normalizeClass, normalizeStyle, resolveDynamicComponent, createElementVNode, createVNode, createCommentVNode, toDisplayString, Fragment, renderSlot, renderList, withModifiers, resolveComponent, withCtx, createTextVNode } from "vue";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_uni_icons = resolveEasycom(resolveDynamicComponent("uni-icons"), __easycom_0$2);
  const _component_uni_swipe_action_item = resolveEasycom(resolveDynamicComponent("uni-swipe-action-item"), __easycom_3);
  const _component_uni_collapse_item = resolveEasycom(resolveDynamicComponent("uni-collapse-item"), __easycom_4);
  const _component_uni_collapse = resolveEasycom(resolveDynamicComponent("uni-collapse"), __easycom_5);
  ...
  return openBlock(), createElementBlock("scroll-view", {
    ...
    createElementVNode("view", { class: "pages font-style" }, [
            ...
            (openBlock(true), createElementBlock(
              ...
              renderList($data.folders, (folder, index) => {
                return openBlock(), createElementBlock("view", { key: index }, [
                  createElementVNode("view", { class: "folder-header" }, [
                    createElementVNode(
                      "u-text",
                      { class: "folder-title" },
        ...
        createVNode(_component_uni_collapse, null, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(
              Fragment,
              null,
              renderList($data.sharedFolders, (folder, index) => {
                return openBlock(), createElementBlock("view", { key: index }, [
                  createElementVNode("view", { class: "folder-header" }, [
                    createElementVNode(
                      "u-text",
        ...
        createVNode(_component_uni_collapse, null, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(
              Fragment,
              null,
              renderList($data.utilities, (folder, index) => {
                return openBlock(), createElementBlock("view", { key: index }, [
                  createElementVNode("view", { class: "folder-header" }, [
                    createElementVNode(
                      "u-text",
      ...
      $data.showPopup ? (openBlock(), createElementBlock("view", {
        key: 0,
        class: "popup-container"
      }, [
        createElementVNode("view", { class: "popup-header" }, [
          ...
          createElementVNode("u-text", { class: "popup-title" }, "Add Item"),
          createVNode(_component_button, {
