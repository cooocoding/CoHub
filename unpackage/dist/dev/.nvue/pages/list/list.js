...
let otherMixins = {};
const _style_0$4 = { "uni-swipe": { "": { "position": "relative" } }, "uni-swipe_box": { "": { "position": "relative" } }, "uni-swipe_text--center": { "": { "width": 100 } }, "uni-swipe_button-group": { "": { "flexDirection": "row", "position": "absolute", "top": 0, "bottom": 0 } }, "button-group--left": { "": { "left": 0, "transform": "translateX(-100%)" } }, "button-group--right": { "": { "right": 0, "transform": "translateX(100%)" } }, "uni-swipe_button": { "": { "flex": 1, "flexDirection": "row", "justifyContent": "center", "alignItems": "center", "paddingTop": 0, "paddingRight": 20, "paddingBottom": 0, "paddingLeft": 20 } }, "uni-swipe_button-text": { "": { "fontSize": 12 } }, "ani": { "": { "transitionProperty": "transform", "transitionDuration": 300, "transitionTimingFunction": "cubic-bezier(0.165,0.84,0.44,1)" } }, "@TRANSITION": { "ani": { "property": "transform", "duration": 300, "timingFunction": "cubic-bezier(0.165,0.84,0.44,1)" } } };
const block0 = {};
const block1 = {};
const _sfc_main$4 = {
...
if (typeof block1 === "function")
  block1(_sfc_main$4);
const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["styles", [_style_0$4]], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-swipe-action/components/uni-swipe-action-item/uni-swipe-action-item.vue"]]);
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("view", {
    ...
    createCommentVNode(" onClick(!isOpen) "),
    createElementVNode(
      "view",
      {
        onClick: _cache[0] || (_cache[0] = ($event) => $options.onClick(!$data.isOpen)),
        class: normalizeClass(["uni-collapse-item__title", { "is-open": $data.isOpen && $props.titleBorder === "auto", "uni-collapse-item-border": $props.titleBorder !== "none" }])
      },
      [
        createElementVNode("view", { class: "uni-collapse-item__title-wrap" }, [
          renderSlot(_ctx.$slots, "title", {}, () => [
            createElementVNode(
              "view",
              {
                class: normalizeClass(["uni-collapse-item__title-box", { "is-disabled": $props.disabled }])
              },
              [
                $props.thumb ? (openBlock(), createElementBlock("u-image", {
                  key: 0,
                  src: $props.thumb,
        ...
        $props.showArrow ? (openBlock(), createElementBlock(
          "view",
          {
            key: 0,
            class: normalizeClass([{ "uni-collapse-item__title-arrow-active": $data.isOpen, "uni-collapse-item--animation": $props.showAnimation === true }, "uni-collapse-item__title-arrow"])
          },
          [
    ...
    createElementVNode(
      "view",
      {
        class: normalizeClass(["uni-collapse-item__wrap", { "is--transition": $props.showAnimation }]),
        style: normalizeStyle({ height: ($data.isOpen ? $data.height : 0) + "px" })
      },
      [
        createElementVNode("view", {
          id: $data.elId,
          ref: "collapse--hook",
          class: normalizeClass(["uni-collapse-item__wrap-content", { open: $data.isheight, "uni-collapse-item--border": $props.border && $data.isOpen }])
        }, [
          renderSlot(_ctx.$slots, "default")
        ], 10, ["id"])
      ],
...
const __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["styles", [_style_0$3]], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-collapse/components/uni-collapse-item/uni-collapse-item.vue"]]);
...
const __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["styles", [_style_0$2]], ["__file", "D:/project/CoHub/CoHub/uni_modules/uni-collapse/components/uni-collapse/uni-collapse.vue"]]);
...
const _sfc_main = {
  ...
  methods: {
    ...
    onqueryerror(e) {
      formatAppLog("error", "at pages/list/list.nvue:254", e);
    },
    onpullingdown(e) {
      formatAppLog("log", "at pages/list/list.nvue:257", e);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_uni_collapse_item = resolveEasycom(resolveDynamicComponent("uni-collapse-item"), __easycom_3);
  const _component_uni_collapse = resolveEasycom(resolveDynamicComponent("uni-collapse"), __easycom_4);
  return openBlock(), createElementBlock("scroll-view", {
    ...
    createElementVNode("view", { class: "pages font-style" }, [
      ...
      createCommentVNode("文件夹折叠"),
      createElementVNode("view", { class: "collapse-wrapper" }, [
        createVNode(_component_uni_collapse, null, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(
              Fragment,
              null,
              renderList($data.folders, (folder, index) => {
                return openBlock(), createBlock(_component_uni_collapse_item, {
                  key: index,
                  title: folder.name
                }, {
                  default: withCtx(() => [
                              ...
                              default: withCtx(() => [
                                createElementVNode("view", {
                                  ...
                                  createElementVNode("view", { class: "item-left" }, [
                                    ...
                                    createElementVNode("view", { class: "item-text" }, [
                                      createElementVNode(
                                        "u-text",
                                        null,
