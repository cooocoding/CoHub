  ...
  return {
    a: common_vendor.f($props.leftOptions, (item, index, i0) => {
      return {
        ...
        c: item.style && item.style.fontSize ? item.style.fontSize : "12px",
        d: index,
...
if (typeof block1 === "function")
  block1(_sfc_main);
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Download/CoHub/CoHub_frontend/uni_modules/uni-swipe-action/components/uni-swipe-action-item/uni-swipe-action-item.vue"]]);
