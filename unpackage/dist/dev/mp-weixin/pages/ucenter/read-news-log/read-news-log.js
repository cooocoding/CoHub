...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "dea540d4-3-" + i0 + "-" + i1 + "," + ("dea540d4-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "dea540d4-2-" + i0 + "-" + i1 + "," + ("dea540d4-1-" + i0)
          };
        }),
        b: "dea540d4-1-" + i0 + ",dea540d4-0",
        c: "dea540d4-4-" + i0 + ",dea540d4-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "dea540d4-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/project/CoHub/CoHub/pages/ucenter/read-news-log/read-news-log.vue"]]);
